...
fit = sampling(disp_model, chains = 1, refresh = 0, data = bird_disp_stan)
...
Our hypothesis that o > 0 is quite probable. Interestingly, our Bayesian estimate is much more conservative than the t.test.
