...
```{r pop_map, cache = TRUE, echo = FALSE, message = FALSE, warning=FALSE,  fig.height = 8}
...
```{r pop_map_kable, cache = TRUE, echo = FALSE, message = FALSE, warning=FALSE}
tab = as.matrix(tapply(counties$population, counties$quantile, mean), nrow = 3)
kableExtra::kable_styling(knitr::kable(tab, caption = "`Mean population size by quantile", digits = 0))
```
:::
...
```{r cancer_quantile_exp_value, cache = TRUE, echo = TRUE, message = FALSE, fig.height = 8}
