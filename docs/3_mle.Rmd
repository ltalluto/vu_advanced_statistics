...
> - What about for continuous problems? There are an infinte number of possible models if $pr(\theta)$ is a continuous PDF.
...
<div class="left lt">
```{r}
optim(p_init, log_posterior, method = "Brent", n = n, 
