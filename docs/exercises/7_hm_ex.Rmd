...
1. We began exploring this dataset in the lecture. One thing that was apparent was that mortality was not predicted well. For the first step, implement the model in the lecture, with partial pooling for both intercepts and slopes using data for *Tsuga canadensis*. Follow the 4-step workflow from lecture. Use the **generated quantities** block in Stan to generate a posterior predictive distribution for trees in 1989 and 2012.

2. Expand your model to include other species. Develop a small number of competing models testing different hypotheses. Possible structures to explore:
