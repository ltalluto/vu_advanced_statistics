...
For this exercise, you will use the `exercises/data/treedata.csv` dataset. This is the same dataset that was used for the MLE Exercises (Nov 5), expanded to include multiple species and years.
