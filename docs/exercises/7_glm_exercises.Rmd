...
5. Produce samples from the model, using either Laplace approximation or MCMC. If you want to use MCMC, you will need to implement a multivariate sampler, or use the sample one provided in [r/mh.r](https://raw.githubusercontent.com/mtalluto/vu_advanced_statistics/main/r/mh.r).
