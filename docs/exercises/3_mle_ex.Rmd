...
```{r}
library(data.table)
## working directory should be: vu_advanced_statistics/docs/exercises
tsuga = readRDS("data/tsuga.rds")

## if you don't have the repository saved locally
# tsuga = readRDS(url("https://github.com/mtalluto/vu_advanced_statistics/raw/main/docs/exercises/data/tsuga.rds"))
```
