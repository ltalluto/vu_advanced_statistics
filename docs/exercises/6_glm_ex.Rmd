...
5. Produce samples from the model, using either Laplace approximation or MCMC. If you want to use MCMC, you may either implement your own multivariate sampler, use the one in [r/mh.r](https://raw.githubusercontent.com/mtalluto/vu_advanced_statistics/main/r/mh.r), or use Stan.
